...
const Sidebar: React.FC = () => {
  ...
  const managementMenus = [
    ...
    },
    {
      ...
      icon: '📅',
      items: [{ id: 'book-appointment', text: 'Book Appointment', icon: '📅', path: '/student/book-appointment' }],
    },
  ];
      ...
      <nav className="sidebar-menu">
        ...
        <div className="menu-group">
          <div className={`menu-item`}>
            <span className="icon">🔍</span>
            <Link className={`menu-item`} to="/student/manageteacher"><span className="text">Search teacher</span></Link>
            
          </div>

          <div className={`menu-item`}>
            <span className="icon">📅</span>
            <Link className={`menu-item`} to="/student/livechat"> <span className="text">Live Chat</span></Link>
          </div>

                    <div className={`menu-item`}>
            <span className="icon">📅</span>
            <Link className={`menu-item`} to="/student/appointment"> <span className="text">Book Appoinment</span></Link>
          </div>

                              <div className={`menu-item`}>
            <span className="icon">📅</span>
            <Link className={`menu-item`} to="/student/allappointment"> <span className="text">All Appoinment</span></Link>
          </div>
        </div>
